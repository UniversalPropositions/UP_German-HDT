...
- `git clone https://github.com/UniversalPropositions/UP_German-HDT.git`
...
- `python3 up2/merge_ud_up.py --input_ud=<ud_path_to_UD_German-HDT>/ --input_up=<up_path_to_UP_German-HDT>/ --output=<path_to_UD+UP_German-HDT>/`
